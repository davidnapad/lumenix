...
export default function VoiceAgentZahnarztDemo() {
  ...
  return (
    <section ref={ref} className="py-16 px-4 bg-white text-center content-visibility-auto">
      ...
      >
        <h2 className="text-3xl font-bold mb-4">Voice Agent Zahnarzt</h2>
        <p className="text-gray-600 mb-8 max-w-3xl mx-auto">
          In dieser Demo hörst du, wie unser Voice Agent automatisch Termine für eine Zahnarztpraxis vergibt und Patientenanfragen beantwortet – ganz ohne menschliches Zutun.
        </p>
        ...
        <div className="relative max-w-3xl mx-auto">
          {!showVideo ? (
            ...
            <div 
              ...
              role="button"
              aria-label="Play zahnarzt voice agent demo"
              tabIndex={0}
              onKeyPress={(e) => {
            ...
            >
              <img 
                src="https://i.postimg.cc/8zZKB7YC/Voice-Agent-2.png" 
                alt="Voice Agent Zahnarzt Vorschau" 
            ...
            // Optimized YouTube iframe with proper containment for mobile
            <div className="relative z-0 aspect-video">
              <iframe
                src="https://www.youtube.com/embed/_ilf6F600c8?rel=0&modestbranding=1&controls=1&autoplay=1&playsinline=1"
                title="Voice Agent Zahnarzt Demo"
